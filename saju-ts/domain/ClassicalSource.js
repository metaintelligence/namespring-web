export var ClassicalSource;
(function (ClassicalSource) {
    ClassicalSource["JEOKCHEONSU"] = "JEOKCHEONSU";
    ClassicalSource["GUNGTONGBOGAM"] = "GUNGTONGBOGAM";
    ClassicalSource["JAPYEONGJINJEON"] = "JAPYEONGJINJEON";
    ClassicalSource["SAMMYEONGTTONGHOE"] = "SAMMYEONGTTONGHOE";
    ClassicalSource["YEONHAEJAYPYEONG"] = "YEONHAEJAYPYEONG";
    ClassicalSource["MYEONGLIJEONGJON"] = "MYEONGLIJEONGJON";
    ClassicalSource["KOREAN_MODERN_PRACTICE"] = "KOREAN_MODERN_PRACTICE";
})(ClassicalSource || (ClassicalSource = {}));
export const CLASSICAL_SOURCE_INFO = {
...
export function inlineCitation(source) {
    return `[출처: ${CLASSICAL_SOURCE_INFO[source].shortLabel}]`;
}
//# sourceMappingURL=ClassicalSource.js.map