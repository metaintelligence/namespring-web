...
import { OFFICIAL_STARS, WEALTH_STARS, appendShinsalNotes, collectSipseongHits, deduplicateByType, } from './LifeDomainShared.js';
function dohwaPositionNote(position) {
...
export function loveDomain(a) {
    ...
    const romanceShinsals = deduplicateByType(a.weightedShinsalHits, new Set([ShinsalType.DOHWA, ShinsalType.HONGYEOM, ShinsalType.GEUMYEO]));
    ...
    const lonelyShinsals = a.weightedShinsalHits.filter(h => h.hit.type === ShinsalType.GOSIN || h.hit.type === ShinsalType.GWASUK);
...
//# sourceMappingURL=LifeDomainLoveSection.js.map