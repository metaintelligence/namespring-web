...
export function buildTouchulReasoning(dayMaster, monthBranch, revealedStem, role, sipseong, type) {
    const roleKorean = (() => {
        switch (role) {
...
export function buildNaegyeokReasoning(dayMaster, monthBranch, sipseong, type) {
...
//# sourceMappingURL=GyeokgukDeterminerReasoning.js.map