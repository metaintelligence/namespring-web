...
function hapTableLookup(a, b) {
    return HAP_TABLE.get(pairKey(a, b));
}
function chungTableLookup(a, b) {
    return CHUNG_TABLE.get(pairKey(a, b));
}
//# sourceMappingURL=CheonganRelationAnalyzer.js.map