...
export function analyzeDayBranchRelation(p1, p2) {
    ...
    const isHyeong = JIJI_HYEONG_PAIRS.some(([a, b]) => (a === db1 && b === db2) || (a === db2 && b === db1));
...
//# sourceMappingURL=CompatibilityDayBranchSection.js.map