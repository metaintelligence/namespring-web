...
import { buildNotAssessedFormation, evaluateFormationRule, hasElementInHidden, hasElementInStems, ohaengKorean, } from './GyeokgukFormationShared.js';
function createHwagyeokSpec(hwashinElement, patternName) {
    ...
    const hasControllingElement = (p) => hasElementInStems(p, controllingElement);
    return {
        patternName,
...
function createIlhaengSpec(dominantElement, patternName) {
