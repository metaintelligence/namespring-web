...
export function sibiUnseongPrinciple(dayMaster, branch, unseong, config) {
...
export function jangSaengBranchFor(dayMaster, config) {
...
export function jangSaengReason(dayMaster, config) {
...
//# sourceMappingURL=LifeStagePrinciples.js.map