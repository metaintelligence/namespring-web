...
export function buildSpecialFeatures(a, config) {
    const lines = [];
    lines.push('■ 특수 요소');
    lines.push('');
    ...
    if (a.resolvedJijiRelations.length > 0) {
        ...
        for (const resolved of a.resolvedJijiRelations) {
            ...
            const significance = RelationSignificanceInterpreter.interpret(resolved.hit.type, resolved.hit.members, a.pillars);
            if (significance) {
...
//# sourceMappingURL=NarrativeSpecialFeaturesSection.js.map